...
class Player(pygame.sprite.Sprite):
    ...
    def sync(self):
        print("Synchronizing")
        #self.gs.factory.data_connection.sendLocation(self.x, self.y)
        #self.gs.factory.data_connection.sendDirection(self.currentDirection)
...
class GameSpace:
    ...
    def gameloop(self):
        ...
        # Synchronize game 30 times a second 
        if (not self.totalTicks % 2):
            self.you.sync()
